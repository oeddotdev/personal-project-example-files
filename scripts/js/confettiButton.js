...
const render = () => {
  ...
  confetti.forEach((confetto, index) => {
    ...
    ctx.fillRect(confetto.position.x, confetto.position.y, confetto.dimensions.x * confetto.scale.x, confetto.dimensions.y * confetto.scale.y);
...
button.querySelectorAll('.button-text').forEach((element) => {
  let characterHTML = '';
  element.innerText.split('').forEach((letter, index, characters) => {
